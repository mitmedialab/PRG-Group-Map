...
export default theme({
    ...
    projects: {
        ...
        "Older Adult Co-Design": {
            summary: "Over a year-long co-design project, we partnered with 28 older adults to understand how social robots should be designed, specifically exploring the areas of medical adherence, emotional wellness, social connection, financial management, memory, body signal monitoring, and exercise. ",
            description: " 'Social robots equipped with AI and designed with users’ social, emotional, and relational interactions in mind are increasingly being highlighted as a way to enable older adults to age in their homes. However, older adults are often excluded in technology development and, in general, in their discussions of needs and desires. To ensure successful and sustained adoption of technology, participatory and co-design processes are essential in social robot development  to make sure older adults feel competent and empowered.' + 
            ...
            links: [ { text: "homepage", link: "https://www.media.mit.edu/projects/co-design-of-social-robots-with-older-adults/overview/" } ,
