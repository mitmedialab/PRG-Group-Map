...
export default theme({
    ...
    projects: {
        ...
        "Robot Policy Design Toolkit": {
            ...
            description: `Increasingly, devices designed with artificial intelligence (AI), such as robots or smart speakers, are entering people’s homes, workspaces, and environments. 
        ...
        "Design Justice": {
            ...
            description: `We take as a starting point for our work the recent scholarship by Sasha Costanza-Chock, Design Justice, in which she described design justice as a framework for analysis of how design distributes benefits and burdens between various groups of people. 
